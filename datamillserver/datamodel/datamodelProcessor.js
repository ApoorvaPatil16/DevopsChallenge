...
var datamodelProcessor = {
    ...
    getfulldatamodel: function(email, datamodelname, successCallback,
        errorCallback) {
        ...
        datamodelModel.find({
            ...
            datamodelstructure.find({
                ...
                if (result1[0] && result1[0].attributes) doc['attributes'] =
                    Object.assign([], result1[0]['_doc']['attributes'])
                datamodelstructure.find({
                    email: email,
                    datamodelname: datamodelname,
                    name: {
    ...
    getDatamodelPatterns: function(email, datamodelname, successCallback,
        errorCallback) {
    ...
    datamodelpatch: function(email, datamodelname, object, successCallback,
        errorCallback) {
        console.log("My object:", object);
        datamodelstructure.remove({
            email: email,
            datamodelname: datamodelname
        }, function(err) {
            if (err) {
                return errorCallback(500,
                    "unable to remove structures/patterns");
            }
            ...
            datamodelstructure.insertMany(docs, function(err, docs) {
                if (err) {
                    ...
                    datamodelModel.findOneAndUpdate({
                        name: datamodelname,
                        email: email
                    }, object, {
                        upsert: true,
    ...
    datamodeldelete: function(email, datamodelname, successCallback,
        errorCallback) {
        datamodelstructure.remove({
            email: email,
            datamodelname: datamodelname
